// controllers/bingoController.js — Updated checkBingo with Card schema integration
import Card from "../models/Card.js"; // ✅ Confirmed: Import Card model
...
// ✅ NEW FUNCTION: Pattern-specific late call detection (unchanged, but uses 2D grid)
const detectLateCallForCurrentPattern = async (
  cardNumbers, // 2D grid from Card
  currentPattern,
  calledNumbers,
  gameId,
  lineInfo = null
